...
Refer to the provided Makefile and ensure that you have all the required libraries installed. I am dabbling in the use of the curses library. Assuming that all is in place, simply compile the code with:
